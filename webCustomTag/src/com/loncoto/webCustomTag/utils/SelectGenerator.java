	...
	public void doTag() throws JspException, IOException {
		...
		for (Object obj : data) {
			...
			try {
				...
				// recupère la classe de l'objet parcouru
				...
				//recupère le getter de keyproperty
				Method mkey = cls.getMethod(methodName);
				//appel le getter de keyproperty
				...
				//recupère le getter de valueproperty
				Method mvalue = cls.getMethod(methodName);
				//appel le getter de valueproperty
				Object value = mvalue.invoke(obj);
				
				writer.print("<option value='" + key + "'>" + value + "</option>");
